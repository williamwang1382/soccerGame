...
public class FXMLControllerPlayer2 extends Main implements Initializable{
    ...
    @FXML void onClickBack(ActionEvent event) throws Exception{
       FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\wwang\\OneDrive\\Desktop\\CS PROJECTS\\soccer game champlain\\soccerGameProject\\src\\main\\Resources\\fxml\\gameMenu.fxml").toURI().toURL());
    ...
    @FXML void onClickConfirm(ActionEvent event) throws Exception{
        if((rbp1c1.isSelected()||rbp1c2.isSelected()||rbp1c3.isSelected())&&(rbp2c1.isSelected()||rbp2c2.isSelected()||rbp2c3.isSelected())){
            ...
            FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\wwang\\OneDrive\\Desktop\\CS PROJECTS\\soccer game champlain\\soccerGameProject\\src\\main\\Resources\\fxml\\gameReady2.fxml").toURI().toURL());
            Parent root = loader.load();
            Stage stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
            Scene scene = new Scene(root);
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        rbp1c1.setOnAction(e -> {
            if (rbp1c1.isSelected()){
                Image image = new Image(new File("C:\\Users\\wwang\\OneDrive\\Desktop\\CS PROJECTS\\soccer game champlain\\soccerGameProject\\src\\main\\Resources\\images\\player1_1.png").toURI().toString());
        ...
        rbp1c2.setOnAction(e -> {
            if (rbp1c2.isSelected()){
                Image image = new Image(new File("C:\\Users\\wwang\\OneDrive\\Desktop\\CS PROJECTS\\soccer game champlain\\soccerGameProject\\src\\main\\Resources\\images\\player2_1.png").toURI().toString());
                imagePane1.getChildren().clear();
                imagePane1.getChildren().add(new ImageView(image));
        ...
        rbp1c3.setOnAction(e -> {
            if (rbp1c3.isSelected()){
                Image image = new Image(new File("C:\\Users\\wwang\\OneDrive\\Desktop\\CS PROJECTS\\soccer game champlain\\soccerGameProject\\src\\main\\Resources\\images\\player3_1.png").toURI().toString());
                imagePane1.getChildren().clear();
                imagePane1.getChildren().add(new ImageView(image));
