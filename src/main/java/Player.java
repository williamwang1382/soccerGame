...
public class Player extends Entity{
    ...
    Image player1_1 = new Image(new File("./src/main/Resources/images/player1_1.png").toURI().toString());
    Image player1_2 = new Image(new File("./src/main/Resources/images/player1_2.png").toURI().toString());
    Image player2_1 = new Image(new File("./src/main/Resources/images/player2_1.png").toURI().toString());
    Image player2_2 = new Image(new File("./src/main/Resources/images/player2_2.png").toURI().toString());
    Image player3_1 = new Image(new File("./src/main/Resources/images/player3_1.png").toURI().toString());
    Image player3_2 = new Image(new File("./src/main/Resources/images/player3_2.png").toURI().toString());
