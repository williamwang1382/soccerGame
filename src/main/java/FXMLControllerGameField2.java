...
public class FXMLControllerGameField2 implements Initializable, Runnable{
    ...
    static Player p1 = new Player(CANVAS_WIDTH/2-100 , CANVAS_HEIGHT/2-32, Direction.RIGHT);
    static Player p2 = new Player(CANVAS_WIDTH/2+100 , CANVAS_HEIGHT/2-32, Direction.LEFT);
