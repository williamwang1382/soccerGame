 ...
 * @author wwang
 */
public class FXMLControllerGameField1 implements Initializable, Runnable{
    @FXML static Canvas canvas;
    ...
    GraphicsContext gc;
    static int CANVAS_WIDTH = 800; static int CANVAS_HEIGHT = 470;
    ...
    @FXML void onClickExit(ActionEvent event) throws Exception{
        FXMLLoader load1 = new FXMLLoader(new File("./src/main/Resources/fxml/gameOver1.fxml").toURI().toURL());
    ...
    public void initialize(URL url, ResourceBundle rb){
        collisions.restartGameObjectsPosition(ball, p1);
        collisions.restartPlayerScores(p1);
