...
public final class Goal extends Entity {
    ...
    Image goal1 = new Image(new File("./src/main/Resources/images/goal1.png").toURI().toString());
    Image goal2 = new Image(new File("./src/main/Resources/images/goal2.png").toURI().toString());
